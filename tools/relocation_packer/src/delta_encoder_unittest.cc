...
// TODO (dimtiry): 1. 0 addend
// TODO (dimtiry): 2. Incorrect packed array for decode
// TODO (dimtiry): 3. Try to catch situation where it is likely to get series of groups with size 1
