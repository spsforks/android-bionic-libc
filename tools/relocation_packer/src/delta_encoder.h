...
// [00] 14                 <- count
// [01] 0x00000000000a2170 <- initial relocation (first relocation - delta, the delta is 8 in this case)
// -- starting the first and only group
// [03] 14                 <- group size
// [03] 0xb                <- flags RELOCATION_GROUP_HAS_ADDEND | RELOCATION_GROUPED_BY_OFFSET_DELTA | RELOCATION_GROUPED_BY_INFO
// [04] 8                  <- offset delta
// [05] 0x403              <- r_info
...
// TODO (dimitry): consider using r_addend_group_delta in the way we use group offset delta, it can safe us more bytes...
