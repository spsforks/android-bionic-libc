...
#if (!defined(__LP64__) && __ANDROID_API__ >= 21) || (defined(__LP64__) && __ANDROID_API__ >= 24)
int multiple_introduced_2() __INTRODUCED_IN_32(21) __INTRODUCED_IN_64(24);
#endif /* (!defined(__LP64__) && __ANDROID_API__ >= 21) || (defined(__LP64__) && __ANDROID_API__ >= 24) */
