...
#if (defined(__LP64__)) || (defined(__arm__) && __ANDROID_API__ >= 13) || \
    (defined(__i386__) && __ANDROID_API__ >= 13)
int multiple_introduced_1() __INTRODUCED_IN_ARM(13) __INTRODUCED_IN_X86(13) __INTRODUCED_IN_64(21);
#endif /* (defined(__LP64__)) || (defined(__arm__) && __ANDROID_API__ >= 13) || (defined(__i386__) \
          && __ANDROID_API__ >= 13) */

#if (defined(__LP64__) && __ANDROID_API__ >= 22) || (defined(__arm__) && __ANDROID_API__ >= 13) || \
    (defined(__i386__) && __ANDROID_API__ >= 13)
int multiple_introduced_2() __INTRODUCED_IN_ARM(13) __INTRODUCED_IN_X86(13) __INTRODUCED_IN_64(22);
#endif /* (defined(__LP64__) && __ANDROID_API__ >= 22) || (defined(__arm__) && __ANDROID_API__ >= \
          13) || (defined(__i386__) && __ANDROID_API__ >= 13) */
