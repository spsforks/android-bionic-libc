...
# recovery images.
# TODO(jiyong): do this with Soong, which currently is impossible beacuse we can't
# install a module to /bionic.
...
ifeq ($(3),lib)
  ...
  LOCAL_MODULE_PATH := $$(TARGET_ROOT_OUT)/bionic/lib
