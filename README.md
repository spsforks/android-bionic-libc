...
Adding a system call usually involves:
  ...
  5. Add basic documentation to the header file. Again, the existing
     ...
     only a brief one-sentence explanation in our documentation. Always
     include the return value/error reporting details (in the same style as
     existing documentation). Explicitly say which version of Android the
     function was added to in the documentation because the documentation
     generation tool doesn't yet understand `__INTRODUCED_IN()`.
