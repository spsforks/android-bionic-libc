...
# -----------------------------------------------------------------------------
# Rebuild the unit tests so they can be run as part of CTS.
# -----------------------------------------------------------------------------
...
# TODO: it seems like a bug that for BUILD_CTS_EXECUTABLE these are different than for BUILD_NATIVE_TEST?
