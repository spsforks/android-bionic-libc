...
# -----------------------------------------------------------------------------
libbionic_gtest_main_src_files := gtest_main.cpp

libbionic_gtest_main_cflags := $(test_cflags)

libbionic_gtest_main_cppflags := $(test_cppflags)

module := libbionic_gtest_main
module_tag := optional
build_type := target
build_target := STATIC_TEST_LIBRARY
include $(LOCAL_PATH)/Android.build.mk
