...
static scalb_intel_data_t g_scalb_intel_data[] = {
  { // Entry 0
    -0.0,
    -0x1.0p-1074,
    -0x1.4p3
...
TEST(math_scalb, scalb_intel) {
#if defined(__BIONIC__)
  for (size_t i = 0; i < sizeof(g_scalb_intel_data)/sizeof(scalb_intel_data_t); i++) {
    EXPECT_DOUBLE_EQ(g_scalb_intel_data[i].expected, scalb(g_scalb_intel_data[i].call_data1, g_scalb_intel_data[i].call_data2)) << "Failed on element " << i;
  }
#else // __BIONIC__
