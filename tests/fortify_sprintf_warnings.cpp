...
void test_memcpy() {
  ...
  // NOLINTNEXTLINE(whitespace/line_length)
  // GCC: warning: call to void* __builtin___memcpy_chk(void*, const void*, unsigned int, unsigned int) will always overflow destination buffer
  // clang should emit a warning, but doesn't
...
void test_memmove() {
  ...
  // NOLINTNEXTLINE(whitespace/line_length)
  // GCC: warning: call to void* __builtin___memmove_chk(void*, const void*, unsigned int, unsigned int) will always overflow destination buffer
  // clang should emit a warning, but doesn't
...
void test_memset() {
  ...
  // NOLINTNEXTLINE(whitespace/line_length)
  // GCC: warning: call to void* __builtin___memset_chk(void*, int, unsigned int, unsigned int) will always overflow destination buffer
  // clang should emit a warning, but doesn't
  memset(buf, 0, 6);
}
...
void test_strcpy() {
  ...
  // NOLINTNEXTLINE(whitespace/line_length)
  // GCC: warning: call to char* __builtin___strcpy_chk(char*, const char*, unsigned int) will always overflow destination buffer
  // clang should emit a warning, but doesn't
...
void test_stpcpy() {
  ...
  // NOLINTNEXTLINE(whitespace/line_length)
  // GCC: warning: call to char* __builtin___stpcpy_chk(char*, const char*, unsigned int) will always overflow destination buffer
  // clang should emit a warning, but doesn't
  stpcpy(buf, "foobar");
}
...
void test_strncpy() {
  ...
  // NOLINTNEXTLINE(whitespace/line_length)
  // GCC: warning: call to char* __builtin___strncpy_chk(char*, const char*, unsigned int, unsigned int) will always overflow destination buffer
  // clang should emit a warning, but doesn't
...
void test_strcat() {
  ...
  // NOLINTNEXTLINE(whitespace/line_length)
  // GCC: warning: call to char* __builtin___strcat_chk(char*, const char*, unsigned int) will always overflow destination buffer
  // clang should emit a warning, but doesn't
...
void test_vsprintf(const char* fmt, ...) {
  ...
  // NOLINTNEXTLINE(whitespace/line_length)
  // GCC: warning: call to int __builtin___vsprintf_chk(char*, int, unsigned int, const char*, __va_list) will always overflow destination buffer
  // clang should emit a warning, but doesn't
...
void test_vsnprintf(const char* fmt, ...) {
  ...
  // NOLINTNEXTLINE(whitespace/line_length)
  // GCC: warning: call to int __builtin___vsnprintf_chk(char*, unsigned int, int, unsigned int, const char*, __va_list) will always overflow destination buffer
  // clang should emit a warning, but doesn't
