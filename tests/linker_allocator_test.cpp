...
TEST(linker_allocator, test_nominal) {
  ...
  allocator.protect_read_only(ptr1);
...
TEST(linker_allocator, test_larger) {
  ...
  allocator.protect_read_only(ptr2);
...
static void protect_one_page() {
  ...
  allocator.protect_read_only(page2_ptr);
...
static void protect_all() {
  ...
  test_struct_larger* page2_ptr = allocator.alloc();
  allocator.protect_all_read_only();
  allocator.protect_all_read_write();
  // check access
