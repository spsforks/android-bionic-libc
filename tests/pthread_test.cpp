...
static void getstack_signal_handler(int sig) {
  ...
  ASSERT_LE(getstack_signal_handler_arg.stack_base, &attr);
  ASSERT_LT(static_cast<void*>(&attr),
            static_cast<char*>(getstack_signal_handler_arg.stack_base) +
            getstack_signal_handler_arg.stack_size);
...
TEST(pthread, pthread_attr_getstack_in_signal_handler) {
  ...
  getstack_signal_handler_arg.stack_base = sig_stack;
  getstack_signal_handler_arg.stack_size = sig_stack_size;
