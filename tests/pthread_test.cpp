...
#if defined(__BIONIC__)
  ASSERT_EXIT(pthread_detach(dead_thread), testing::KilledBySignal(SIGABRT), "No such thread id");
#else
...
#if defined(__BIONIC__)
  ASSERT_EXIT(pthread_join(dead_thread, NULL), testing::KilledBySignal(SIGABRT), "No such thread id");
#else
...
#if defined(__BIONIC__)
  ASSERT_EXIT(pthread_kill(dead_thread, 0), testing::KilledBySignal(SIGABRT), "No such thread id");
#else
