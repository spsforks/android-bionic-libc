...
TEST(FNMATCH_TEST, glob) {
  ...
  static const std::vector<conditions> tests = {
    ...
    { false, "?(fnmatch)",         "X(fnmatch)",             0 },
    { true,  "?(fnmatch)",         "fnmatch",                0 },
    { true,  "?(fn*tc|help)",      "fnmatch",                0 },
    { true,  "?(fn*tc|fnmatch)",   "fnmatch",                0 },
    { true,  "?(fn*tch|help)",     "fnmatch",                0 },
    { true,  "?(fn*tch|help)",     "fnmatchfnmatch",         0 },
    { true,  "*(fnmatch)",         "",                       0 },
    { true,  "*(fn*tc|help)",      "fnmatch",                0 },
    { true,  "*(fn*tc|fnmatch)",   "fnmatchfnmatch",         0 },
    { true,  "+(fn*tc|help)",      "fnmatch",                0 },
    { true,  "+(fn*tc|fnmatch)",   "fnmatch",                0 },
    { true,  "+(fn*tc|fnmatch)",   "",                       0 },
    { true,  "@(fn*tc|help)",      "fnmatch",                0 },
    ...
    { true,  "@(fn*tc|fnmatch)",   "",                       0 },
    { true,  "@(fn*tc|fnmatch)",   "fnmatchfnmatch",         0 },
    { true,  "!(help)fnmatch",     "fnmatch",                0 },
    { true,  "!(fn*tc|fnmatc)h",   "fnmatch",                0 },
    ...
    { true,  "BM_time_@(clock_@(get*\\res|gettime)|gettimeofday|ti*\\me)*",
                                   "BM_time_time_syscall",   0 },
    { true,  "a+(b)c",             "abc",                    0 },
    { true,  "a+(b+(c)d)f",        "abcdf",                  0 },
    { true,  "a+(b\\+(c)d)f",      "abcdf",                  0 },
    { true,  "a+(b\\+(c)d)f",      "ab+(c)df",               0 },
    { true,  "a+(b\\+(c)d)f",      "ab+(cd)f",               0 },
    { true,  "a+(b\\+(c\\)d)f",    "ab+(c)df",               0 },
    { true,  "a+(b\\+(c)d)f",      "abcdf",                  FNM_NOESCAPE },
    { true,  "a+(b\\+(c)d)f",      "ab\\cdf",                FNM_NOESCAPE },
    { true,  "a+(b+\\(c)d)f",      "abcdf",                  0 },
    { true,  "a+(b+\\(c)d)f",      "ab+(c)df",               0 },
    { true,  "a+(b+\\(c\\)d)f",    "ab+(c)df",               0 },
    { true,  "a+(b+\\(c\\)d)f",    "abcdf",                  FNM_NOESCAPE },
    { true,  "a+(b+\\(c\\)d)f",    "ab+\\(c\\d)f",           FNM_NOESCAPE },
#ifdef FNM_EXTMATCH // And now the expected results with the flag
    { true,  "?(fnmatch)",         "X(fnmatch)",             FNM_EXTMATCH },
