...
<<<<<<< TARGET BRANCH (3f7cd8 Merge "Merge "time.mktime_EOVERFLOW: set an explicit timezon)
...
>>>>>>> SOURCE BRANCH (30fc7d [RESTRICT AUTOMERGE] uchar/wchar tests: allow both Android 1)
  char16_t out;
