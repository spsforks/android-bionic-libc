...
// defined in main executable.
extern "C" int main_global_default_serial() {
  return 2716057;
}

// Even though this one is defined by main
// executable - it should not be preempted
// because of protected visibility
extern "C" int __attribute__((visibility("protected"))) main_global_protected_serial() {
  return 3370318;
}
...
// Trying to preempt functions from DT_NEEDED so
