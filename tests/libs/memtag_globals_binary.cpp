...
void exe_print() {
  ...
  exe_static_dyninit = "123456789012345678901234567890";
...
int main() {
  ...
  exe_check_assertions();

  fprintf(stderr, "Assertions were passed. Now doing a global-buffer-overflow.\n");
  crash();
