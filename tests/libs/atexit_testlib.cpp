...
// last
static void atexit_handler_regular() { *atexit_sequence += " a wall"; }
...
extern "C" int get_cxx_ctor_called() { return cxx_ctor_called; }

extern "C" int get_attr_ctor_called() { return attr_ctor_called; }
