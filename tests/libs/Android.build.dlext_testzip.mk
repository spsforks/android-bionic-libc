...
$($(bionic_2nd_arch_prefix)bionic_dlext_test_zip)_prepare: $($(bionic_2nd_arch_prefix)bionic_dlext_built_shared_libraries)
	$(hide) mkdir -p $($(bionic_2nd_arch_prefix)bionic_dlext_test_zip_tmpdir)
	$(hide) cp -p $($(bionic_2nd_arch_prefix)TARGET_OUT_INTERMEDIATE_LIBRARIES)/libdlext_test_fd.so \
      $($(bionic_2nd_arch_prefix)bionic_dlext_test_zip_tmpdir)
