...
$(LOCAL_BUILT_MODULE): $(my_shared_libs) $(BIONIC_TESTS_ZIPALIGN)
	...
	$(hide) (cd $(dir $@)/zipdir && touch empty_file.txt && zip -qrD0 ../$(notdir $@).unaligned empty_file.txt libdir/*.so)
...
$(LOCAL_BUILT_MODULE) : $(lib_d) $(lib_a) $(lib_b) $(lib_c) $(lib_x) $(BIONIC_TESTS_ZIPALIGN)
	...
	$(hide) (cd $(dir $@)/zipdir && touch empty_file.txt && zip -qrD0 ../$(notdir $@).unaligned empty_file.txt libdir)
	$(hide) $(BIONIC_TESTS_ZIPALIGN) 4096 $@.unaligned $@
