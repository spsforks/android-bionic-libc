...
// normal: GOT(dso_static) = RELATIVE(0x[dso_static])
static char dso_static[10];
// normal: GOT(dso_static_end) = RELATIVE(0x[dso_static] + 10)
static char* dso_static_end = &dso_static[17];
static const char* dso_static_end_const = &dso_static[17];

// normal: GOT(dso_global) = GLOB_DAT(dso_global)
// bsymbolic: GOT(dso_global) = RELATIVE(0x[dso_global])
char dso_global[10];
// normal: GOT(dso_global_end) = ABS64(dso_global, 10)
//         *0x[dso_global_end] = ABS64(dso_global, 10)
// bsymbolic: GOT(dso_global_end) = RELATIVE(0x[dso_global] + 10)
//            *0x[dso_global_end] = RELATIVE(0x[dso_global] + 10)
