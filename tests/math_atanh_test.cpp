...
static atanh_intel_data_t g_atanh_intel_data[] = {
  { // Entry 0
    -0x1.p-1074,
    -0x1.0p-1074
  },
...
TEST(math_atanh, atanh_intel) {
#if defined(__BIONIC__)
  for (size_t i = 0; i < sizeof(g_atanh_intel_data)/sizeof(atanh_intel_data_t); i++) {
    EXPECT_DOUBLE_EQ(g_atanh_intel_data[i].expected, atanh(g_atanh_intel_data[i].call_data)) << "Failed on element " << i;
  }
#else // __BIONIC__
