...
TEST(dlext, ns_cyclic_namespaces) {
  ...
  ASSERT_TRUE(android_link_namespaces(ns2, ns1, g_core_shared_libs.c_str())) << dlerror();
  ASSERT_TRUE(android_link_namespaces(ns1, ns2, g_core_shared_libs.c_str())) << dlerror();
