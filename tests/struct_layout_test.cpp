...
#define CHECK_OFFSET(name, field, offset) \
...
#ifdef __LP64__
  CHECK_SIZE(pthread_internal_t, 752);
  ...
  CHECK_OFFSET(pthread_internal_t, stack_maybe_modified, 84);
  CHECK_OFFSET(pthread_internal_t, stack_cache_entry, 88);
  CHECK_OFFSET(pthread_internal_t, cleanup_stack, 96);
  CHECK_OFFSET(pthread_internal_t, start_routine, 104);
  CHECK_OFFSET(pthread_internal_t, start_routine_arg, 112);
  CHECK_OFFSET(pthread_internal_t, return_value, 120);
  CHECK_OFFSET(pthread_internal_t, start_mask, 128);
  ...
  CHECK_OFFSET(pthread_internal_t, thread_local_dtors, 208);
  CHECK_OFFSET(pthread_internal_t, current_dlerror, 216);
  CHECK_OFFSET(pthread_internal_t, dlerror_buffer, 224);
  CHECK_OFFSET(pthread_internal_t, bionic_tls, 736);
  CHECK_OFFSET(pthread_internal_t, errno_value, 744);
...
#else
  CHECK_SIZE(pthread_internal_t, 644);
  CHECK_OFFSET(pthread_internal_t, next, 0);
  ...
  CHECK_OFFSET(pthread_internal_t, stack_maybe_modified, 44);
  CHECK_OFFSET(pthread_internal_t, stack_cache_entry, 48);
  CHECK_OFFSET(pthread_internal_t, cleanup_stack, 52);
  CHECK_OFFSET(pthread_internal_t, start_routine, 56);
  CHECK_OFFSET(pthread_internal_t, start_routine_arg, 60);
  CHECK_OFFSET(pthread_internal_t, return_value, 64);
  CHECK_OFFSET(pthread_internal_t, start_mask, 68);
  CHECK_OFFSET(pthread_internal_t, alternate_signal_stack, 76);
  CHECK_OFFSET(pthread_internal_t, shadow_call_stack_guard_region, 80);
  CHECK_OFFSET(pthread_internal_t, stack_top, 84);
  CHECK_OFFSET(pthread_internal_t, startup_handshake_lock, 92);
  CHECK_OFFSET(pthread_internal_t, mmap_base, 100);
  CHECK_OFFSET(pthread_internal_t, mmap_size, 104);
  CHECK_OFFSET(pthread_internal_t, mmap_base_unguarded, 108);
  CHECK_OFFSET(pthread_internal_t, mmap_size_unguarded, 112);
  CHECK_OFFSET(pthread_internal_t, thread_local_dtors, 116);
  CHECK_OFFSET(pthread_internal_t, current_dlerror, 120);
  CHECK_OFFSET(pthread_internal_t, dlerror_buffer, 124);
  CHECK_OFFSET(pthread_internal_t, bionic_tls, 636);
  CHECK_OFFSET(pthread_internal_t, errno_value, 640);
