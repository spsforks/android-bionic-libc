...
TEST(unistd, _POSIX_macros_smoke) {
  ...
  EXPECT_EQ(0, _POSIX_CPUTIME);             // Need to use sysconf to detect support in runtime.
  ...
  EXPECT_EQ(0, _POSIX_THREAD_CPUTIME);       // Need to use sysconf to detect support in runtime.
