...
static void HwasanVforkTestChild() {
...
__attribute__((noinline))
static void HwasanReadMemory(const char *p, size_t size) {
...
__attribute__((noinline, no_sanitize("hwaddress")))
static void HwasanVforkTestParent() {
