...
<<<<<<< TARGET BRANCH (98b842 Merge "[automerger skipped] Merge "Fix Bionic dlfcn.dladdr_l)
#else
...
>>>>>>> SOURCE BRANCH (ce45ee Merge "Fix linker path for emulated architecture" into andro)
#endif
#else
#error "Unknown architecture"
#endif
