...
static void* gmtime_stack_overflow_14313703_fn(void*) {
...
TEST(time, gmtime_stack_overflow_14313703) {
  ...
  pthread_t t;
  ASSERT_EQ(0, pthread_create(&t, &attributes, gmtime_stack_overflow_14313703_fn, NULL));
  void* result;
