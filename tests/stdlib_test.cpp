...
TEST(stdlib, atof) { ASSERT_DOUBLE_EQ(1.23, atof("1.23")); }

TEST(stdlib, strtod) { ASSERT_DOUBLE_EQ(1.23, strtod("1.23", NULL)); }

TEST(stdlib, strtof) { ASSERT_FLOAT_EQ(1.23, strtof("1.23", NULL)); }

TEST(stdlib, strtold) { ASSERT_DOUBLE_EQ(1.23, strtold("1.23", NULL)); }
...
static void quick_exit_2(void) { ASSERT_EQ(quick_exit_status, 1); }

static void not_run(void) { FAIL(); }
