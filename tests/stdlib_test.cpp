...
TEST(stdlib, strtod_largest_subnormal) {
  ...
  if (PLATFORM_VERSION_AT_LEAST(__ANDROID_API_L__)) {
    ...
    ASSERT_DOUBLE_EQ(2.2250738585072014e-308, strtod("0.00022250738585072012e-304", NULL));
    ASSERT_DOUBLE_EQ(2.2250738585072014e-308, strtod("00000002.2250738585072012e-308", NULL));
    ASSERT_DOUBLE_EQ(2.2250738585072014e-308, strtod("2.225073858507201200000e-308", NULL));
    ASSERT_DOUBLE_EQ(2.2250738585072014e-308, strtod("2.2250738585072012e-00308", NULL));
    ASSERT_DOUBLE_EQ(2.2250738585072014e-308, strtod("2.22507385850720129978001e-308", NULL));
    ASSERT_DOUBLE_EQ(-2.2250738585072014e-308, strtod("-2.2250738585072012e-308", NULL));
  }
}
