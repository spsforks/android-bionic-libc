 ...
 * command. Speifically, delete everything before the path/to/the/compiler, then delete the first
 ...
 *
 * If you delete everything before clang++, and delete "CLANG" (or "GCC" if gcc is failing), and
 * you'll end up with:
 *
