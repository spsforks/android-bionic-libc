...
TEST(STDIO_TEST, sscanf_w_arguments_reordering) {
#if defined(__BIONIC__)
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wformat-invalid-specifier"
#pragma clang diagnostic ignored "-Wformat-extra-args"
  ...
  EXPECT_EQ(2, sscanf("<0b10101010101010101010101010101010 0x3333333344444444>", "<%w32b %w64x>",
                      &a, &b));
  ...
  EXPECT_EQ(
      3,
      sscanf("<0x1111111122222222 0b101010101010101010101010101010101010101010101010101010101010 "
             "0x3333333344444444>",
             "<%w64x %w64b %w64x>", &c, &d, &e));
  EXPECT_EQ(0x1111111122222222, c);
  EXPECT_EQ(0xaaaaaaaaaaaaaaa, d);
  EXPECT_EQ(0x3333333344444444, e);
#pragma clang diagnostic pop
#else
  GTEST_SKIP() << "no %w in glibc";
#endif
...
TEST(STDIO_TEST, swscanf_w_arguments_reordering) {
#if defined(__BIONIC__)
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wformat-invalid-specifier"
#pragma clang diagnostic ignored "-Wformat-extra-args"
  ...
  EXPECT_EQ(2, swscanf(L"<0b10101010101010101010101010101010 0x3333333344444444>", L"<%w32b %w64x>",
                       &a, &b));
  EXPECT_EQ(0xaaaaaaaa, a);
  EXPECT_EQ(0x3333333344444444, b);
  ...
  EXPECT_EQ(
      3,
      swscanf(L"<0x1111111122222222 0b101010101010101010101010101010101010101010101010101010101010 "
              L"0x3333333344444444>",
              L"<%w64x %w64b %w64x>", &c, &d, &e));
  EXPECT_EQ(0x1111111122222222, c);
  EXPECT_EQ(0xaaaaaaaaaaaaaaa, d);
  EXPECT_EQ(0x3333333344444444, e);
#pragma clang diagnostic pop
