...
#pragma clang diagnostic ignored "-Wformat-extra-args"
  ...
  EXPECT_STREQ("99aabbccddeef0f0 and 1122334455667788", buf);
  snprintf(buf, sizeof(buf), "%1$w64x %2$w32i", h, d);
  EXPECT_STREQ("1122334455667788 10", buf);
  snprintf(buf, sizeof(buf), "%2$w32i %1$w64x", h, d);
  EXPECT_STREQ("10 1122334455667788", buf);
#pragma clang diagnostic pop
}