...
TEST(dlfcn, dlopen_check_relocation_dt_needed_order) {
  // This is structure of the test library and
  ...
  //
  // Root library references relo_test_get_answer_lib - which is defined
  // in both dt_needed libraries, the correct relocation should
  // use function defined in libtest_relo_check_dt_needed_order_1.so
  void* handle = nullptr;
