...
TEST(android_mallopt, tag_level) {
  ...
  int tag_level = M_HEAP_TAGGING_LEVEL_NONE;
  EXPECT_TRUE(android_mallopt(M_SET_HEAP_TAGGING_LEVEL, &tag_level, sizeof(int)));
  ...
  EXPECT_FALSE(android_mallopt(M_SET_HEAP_TAGGING_LEVEL, &tag_level, sizeof(int)));
