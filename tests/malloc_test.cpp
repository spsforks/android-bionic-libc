...
TEST(malloc, memalign_overflow) { ASSERT_EQ(NULL, memalign(4096, SIZE_MAX)); }
...
TEST(malloc, pvalloc_overflow) { ASSERT_EQ(NULL, pvalloc(SIZE_MAX)); }
...
TEST(malloc, valloc_overflow) { ASSERT_EQ(NULL, valloc(SIZE_MAX)); }
#endif
