...
TEST(math, acosh_intel) {
  DoMathDataTest<1>(g_acosh_intel_data, acosh);
}

#include "math_data/acoshf_intel_data.h"
TEST(math, acoshf_intel) {
  DoMathDataTest<1>(g_acoshf_intel_data, acoshf);
}
...
TEST(math, atanh_intel) {
  DoMathDataTest<1>(g_atanh_intel_data, atanh);
}

#include "math_data/atanhf_intel_data.h"
TEST(math, atanhf_intel) {
  DoMathDataTest<1>(g_atanhf_intel_data, atanhf);
}
...
TEST(math, cosh_intel) {
  DoMathDataTest<1>(g_cosh_intel_data, cosh);
}

#include "math_data/coshf_intel_data.h"
TEST(math, coshf_intel) {
  DoMathDataTest<1>(g_coshf_intel_data, coshf);
}
...
TEST(math, sinh_intel) {
  DoMathDataTest<1>(g_sinh_intel_data, sinh);
}

#include "math_data/sinhf_intel_data.h"
TEST(math, sinhf_intel) {
  DoMathDataTest<1>(g_sinhf_intel_data, sinhf);
}
...
TEST(math, tanh_intel) {
  DoMathDataTest<1>(g_tanh_intel_data, tanh);
}

#include "math_data/tanhf_intel_data.h"
TEST(math, tanhf_intel) {
  DoMathDataTest<1>(g_tanhf_intel_data, tanhf);
}
