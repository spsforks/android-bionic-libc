...
TEST(properties, __system_property_add) {
    ...
    system_properties.AreaInit((dir.path + "/__properties__"s).c_str());
...
TEST(properties, system_properties_update) {
#if defined(__BIONIC__)
    TemporaryDir dir;
    SystemProperties system_properties;
    system_properties.AreaInit((dir.path + "/__properties__"s).c_str());
...
TEST(properties, system_properties_foreach) {
#if defined(__BIONIC__)
    TemporaryDir dir;
    SystemProperties system_properties;
    system_properties.AreaInit((dir.path + "/__properties__"s).c_str());
...
TEST(properties, system_properties_find_nth) {
#if defined(__BIONIC__)
    TemporaryDir dir;
    SystemProperties system_properties;
    system_properties.AreaInit((dir.path + "/__properties__"s).c_str());
    ...
    for (int i = 0; i < 8; i++) {
        for (int j = 0; j < 8; j++) {
            for (int k = 0; k < 8; k++) {
                ...
                ASSERT_EQ(0, system_properties.Add(prop_name, PROP_NAME_MAX - 1, prop_value, PROP_VALUE_MAX - 1));
            }
        }
    }
...
TEST(properties, system_properties_serial) {
#if defined(__BIONIC__)
    TemporaryDir dir;
    SystemProperties system_properties;
    system_properties.AreaInit((dir.path + "/__properties__"s).c_str());
...
TEST(properties, system_properties_wait_any) {
#if defined(__BIONIC__)
    TemporaryDir dir;
    SystemProperties system_properties;
    system_properties.AreaInit((dir.path + "/__properties__"s).c_str());
...
TEST(properties, system_properties_wait) {
#if defined(__BIONIC__)
    TemporaryDir dir;
    SystemProperties system_properties;
    system_properties.AreaInit((dir.path + "/__properties__"s).c_str());
...
TEST(properties, system_properties_extra_long_read_only) {
#if defined(__BIONIC__)
    TemporaryDir dir;
    SystemProperties system_properties;
    system_properties.AreaInit((dir.path + "/__properties__"s).c_str());
  ...
  auto check_with_legacy_read = [&system_properties](const std::string& name, const std::string& expected_value) {
    char value[PROP_VALUE_MAX];
  ...
  auto check_with_read_callback = [&system_properties](const std::string& name, const std::string& expected_value) {
...
TEST(properties, system_properties_extra_long_read_only_too_long) {
#if defined(__BIONIC__)
    TemporaryDir dir;
    SystemProperties system_properties;
    system_properties.AreaInit((dir.path + "/__properties__"s).c_str());
