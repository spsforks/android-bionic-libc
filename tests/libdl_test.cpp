...
TEST(libdl, application_disabled_changes) {
  // Check initial values
  ASSERT_EQ(true, android_is_change_enabled(1));
  ASSERT_EQ(true, android_is_change_enabled(2));
  ASSERT_EQ(true, android_is_change_enabled(3));

  long int disabled_changes[] = {2, 3};
  android_set_application_disabled_changes(disabled_changes, 2);
  ASSERT_EQ(true, android_is_change_enabled(1));
  ASSERT_EQ(false, android_is_change_enabled(2));
  ASSERT_EQ(false, android_is_change_enabled(3));
}
