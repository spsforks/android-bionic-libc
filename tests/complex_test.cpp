...
TEST(complex, cabs) { ASSERT_EQ(0.0, cabs(0)); }

extern "C" float cabsf(float _Complex);
TEST(complex, cabsf) { ASSERT_EQ(0.0, cabsf(0)); }

extern "C" long double cabsl(long double _Complex);
TEST(complex, cabsl) { ASSERT_EQ(0.0, cabsl(0)); }

extern "C" double _Complex cacos(double _Complex);
TEST(complex, cacos) { ASSERT_EQ(M_PI / 2.0, cacos(0.0)); }
...
TEST(complex, cacosh) { ASSERT_EQ(0.0, cacosh(1.0)); }

extern "C" float _Complex cacoshf(float _Complex);
TEST(complex, cacoshf) { ASSERT_EQ(0.0, cacoshf(1.0)); }

extern "C" double carg(double _Complex);
TEST(complex, carg) { ASSERT_EQ(0.0, carg(0)); }
...
TEST(complex, casinf) { ASSERT_EQ(0.0, casinf(0)); }

extern "C" double _Complex casinh(double _Complex);
TEST(complex, casinh) { ASSERT_EQ(0.0, casinh(0)); }

extern "C" float _Complex casinhf(float _Complex);
TEST(complex, casinhf) { ASSERT_EQ(0.0, casinhf(0)); }
...
TEST(complex, catanh) { ASSERT_EQ(0.0, catanh(0)); }

extern "C" float _Complex catanhf(float _Complex);
TEST(complex, catanhf) { ASSERT_EQ(0.0, catanhf(0)); }

extern "C" double _Complex ccos(double _Complex);
TEST(complex, ccos) { ASSERT_EQ(1.0, ccos(0)); }

extern "C" float _Complex ccosf(float _Complex);
TEST(complex, ccosf) { ASSERT_EQ(1.0, ccosf(0)); }

extern "C" double _Complex ccosh(double _Complex);
TEST(complex, ccosh) { ASSERT_EQ(1.0, ccosh(0)); }

extern "C" float _Complex ccoshf(float _Complex);
TEST(complex, ccoshf) { ASSERT_EQ(1.0, ccoshf(0)); }

extern "C" double _Complex cexp(double _Complex);
TEST(complex, cexp) { ASSERT_EQ(1.0, cexp(0)); }

extern "C" float _Complex cexpf(float _Complex);
TEST(complex, cexpf) { ASSERT_EQ(1.0, cexpf(0)); }

extern "C" double cimag(double _Complex);
TEST(complex, cimag) { ASSERT_EQ(0.0, cimag(0)); }

extern "C" float cimagf(float _Complex);
TEST(complex, cimagf) { ASSERT_EQ(0.0f, cimagf(0)); }
...
TEST(complex, conj) { ASSERT_EQ(0.0, conj(0)); }
...
TEST(complex, conjl) { ASSERT_EQ(0.0, conjl(0)); }
...
TEST(complex, csinh) { ASSERT_EQ(0.0, csinh(0)); }

extern "C" float _Complex csinhf(float _Complex);
TEST(complex, csinhf) { ASSERT_EQ(0.0, csinhf(0)); }

extern "C" double _Complex csqrt(double _Complex);
TEST(complex, csqrt) { ASSERT_EQ(0.0, csqrt(0)); }

extern "C" float _Complex csqrtf(float _Complex);
TEST(complex, csqrtf) { ASSERT_EQ(0.0f, csqrt(0)); }

extern "C" long double _Complex csqrtl(long double _Complex);
TEST(complex, csqrtl) { ASSERT_EQ(0.0, csqrtl(0)); }
...
TEST(complex, ctanh) { ASSERT_EQ(0.0, ctanh(0)); }

extern "C" float _Complex ctanhf(float _Complex);
TEST(complex, ctanhf) { ASSERT_EQ(0.0, ctanhf(0)); }
