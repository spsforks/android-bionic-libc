...
// return 0 if all tests run successfully, otherwise return 1.
static int RunTestInSeparateProc(int argc, char** argv, std::vector<TestCase>& testcase_list,
...
int main(int argc, char** argv) {
  ...
  if (options.isolate == true) {
    ...
    return RunTestInSeparateProc(argc, arg_list.data(), testcase_list, options.gtest_repeat,
