...
<<<<<<< PATCH SET (2a5473 [RFC]Add riscv64 support)
  ...
  // and AArch64 and x86_64 and RISCV64 all have a SIGRTMAX defined as 64.
=======
...
>>>>>>> BASE      (9874c5 Merge "Nullability check for regex module.")
#if defined(__BIONIC__)
