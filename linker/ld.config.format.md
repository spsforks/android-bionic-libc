...
The mappigs should be defined between start of ld.config.txt and the first section.

## Section

Every section starts with `[section_name]` and is basically set of properties. The following
is an example of how to define a section:
