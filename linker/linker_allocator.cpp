...
// designed to provide basic functionality of malloc/free/realloc
// libc functions.
//
// On alloc:
...
// On free:
//
// For the pointer allocated using proxy-to-mmap allocator unmaps
// the memory.
//
// For the pointer allocated using SmallObjectAllocator it adds
// the block to free_blocks_list_. If number of free pages reaches 2
// SmallObjectAllocator munmaps one of the pages keeping another one
// in reserve.
