...
// there is no reason to invoke small object block allocator
// if memory size is less than 1k. We are not going to save anything.
static const size_t kSmallObjectMaxSize = 1024;
static const uint32_t kSmallObjectMaxSizeLog2 = 10;
static const uint32_t kSmallObjectMinSizeLog2 = 4;
...
LinkerMemoryAllocator::LinkerMemoryAllocator() {
  static const char* allocator_names[] = {
    "linker_alloc_16", // 2^4
    "linker_alloc_32", // 2^5
