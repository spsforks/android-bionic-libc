...
void _dl_android_set_application_target_sdk_version(uint32_t target) {
...
static const char ANDROID_LIBDL_STRTAB[] =
  ...
  // 00000000001 1111111112222222222 33333333334444444444555555555566666666667777777 77788888888889999999999
  // 01234567890 1234567890123456789 01234567890123456789012345678901234567890123456 78901234567890123456789
    "erate_phdr\0android_dlopen_ext\0_dl_android_set_application_target_sdk_version\0_dl_andorid_get_applica"
  // 000000000011111111112222
  // 012345678901234567890123
    "tion_target_sdk_version\0"
#if defined(__arm__)
  // 224
...
static ElfW(Sym) g_libdl_symtab[] = {
  ...
  ELFW(SYM_INITIALIZER)(130, &_dl_android_set_application_target_sdk_version, 1),
  ELFW(SYM_INITIALIZER)(177, &_dl_android_get_application_target_sdk_version, 1),
#if defined(__arm__)
  ELFW(SYM_INITIALIZER)(224, &dl_unwind_find_exidx, 1),
#endif
};
