...
bool _dl_android_set_application_sdk_versions(uint32_t target, uint32_t min, uint32_t max) {
  ScopedPthreadMutexLocker locker(&g_dl_mutex);
  return set_application_sdk_versions(target, min, max);
}

uint32_t _dl_android_get_application_target_sdk_version() {
  ScopedPthreadMutexLocker locker(&g_dl_mutex);
...
static const char ANDROID_LIBDL_STRTAB[] =
  ...
  // 00000000001 1111111112222222222 33333333334444444444555555555566666666667 77777777788888888889999999999
  // 01234567890 1234567890123456789 01234567890123456789012345678901234567890 12345678901234567890123456789
    "erate_phdr\0android_dlopen_ext\0_dl_android_set_application_sdk_versions\0_dl_andorid_get_application_t"
  // 000000000011111111
  // 012345678901234567
    "arget_sdk_version\0"
#if defined(__arm__)
...
static ElfW(Sym) g_libdl_symtab[] = {
  ...
  ELFW(SYM_INITIALIZER)(130, &_dl_android_set_application_sdk_versions, 1),
  ELFW(SYM_INITIALIZER)(171, &_dl_android_get_application_target_sdk_version, 1),
#if defined(__arm__)
  ELFW(SYM_INITIALIZER)(218, &dl_unwind_find_exidx, 1),
#endif
};
