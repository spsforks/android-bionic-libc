...
static const char ANDROID_LIBDL_STRTAB[] =
  ...
  // 4*
  // 0000000000111111111122222 222223333333333444 4444444555555555566666666667777777777888 88888889999999999
  // 0123456789012345678901234 567890123456789012 3456789012345678901234567890123456789012 34567890123456789
    "loader_android_dlwarning\0__loader_cfi_fail\0__loader_android_use_fallback_allocator\0"
#if defined(__arm__)
  // 483
...
static ElfW(Sym) g_libdl_symtab[] = {
  ...
  ELFW(SYM_INITIALIZER)(443, &__android_use_fallback_allocator, 1),
#if defined(__arm__)
  ELFW(SYM_INITIALIZER)(483, &__dl_unwind_find_exidx, 1),
#endif
};
