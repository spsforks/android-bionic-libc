...
soinfo* get_libdl_info() {
  if (__libdl_info.name[0] == '\0') {
    ...
    __libdl_info.symtab = gLibDlSymtab;
    __libdl_info.nbucket = sizeof(gLibDlBuckets)/sizeof(unsigned);
    __libdl_info.nchain = sizeof(gLibDlChains)/sizeof(unsigned);
    __libdl_info.bucket = gLibDlBuckets;
    __libdl_info.chain = gLibDlChains;
