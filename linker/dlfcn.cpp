...
#elif defined(ANDROID_MIPS_LINKER) || defined(ANDROID_X86_LINKER) || defined(ANDROID_X86_64_LINKER) || defined(ANDROID_AARCH64_LINKER)
...
#else
#error Unsupported architecture. Only ARM, MIPS, x86, x86_64 and AARCH64 are presently supported.
#endif
