...
template<typename T>
class LinkedListFunctors {
 public:
  typedef linked_list_entry<T>* (*alloc_t)();
  typedef void (*free_t)(linked_list_entry<T>*);
};

/*
 * Represents linked list of objects of type T
 */
template<typename T, typename LinkedListFunctors<T>::alloc_t alloc, typename LinkedListFunctors<T>::free_t free>
class LinkedList {
 public:
  LinkedList() : head_(nullptr) {}

  void add(const T& element) {
    linked_list_entry<T>* new_entry = alloc();
