...
$(error "TARGET_CPU_VARIANT not set or set to an unknown value. Possible values are: $(SUPPORTED_CPU_VARIANTS) Use generic for devices that do not have a CPU similar to any of the supported cpu variants.")
endif
