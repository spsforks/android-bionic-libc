...
$(error "TARGET_CPU_VARIANT not set or set to an unknown value. Possible values are generic, denver64, exynos-m1. Use generic for devices that do not have a CPU similar to any of the supported cpu variants.")
endif
