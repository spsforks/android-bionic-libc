...
class KernelArgumentBlock {
 public:
  ...
  // Remove the specified number of arguments from the front of the kernel
  // argument block's argv, shifting the envp and auxv arrays towards the
  // front of the block. The block needs to remain at the same address because
  // its address is the initial stack pointer value on entry to a program, and
