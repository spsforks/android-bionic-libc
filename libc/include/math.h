...
double nan(const char* __BIONIC_COMPLICATED_NULLNESS __kind) __attribute_const__;
float nanf(const char* __BIONIC_COMPLICATED_NULLNESS __kind) __attribute_const__;
long double nanl(const char* __BIONIC_COMPLICATED_NULLNESS __kind) __RENAME_LDBL(nan, 13, 13) __attribute_const__;
