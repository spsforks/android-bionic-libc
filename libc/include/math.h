...
double scalbln(double __x, long __exponent) __INTRODUCED_IN_X86(18);
float scalblnf(float __x, long __exponent) __INTRODUCED_IN_X86(18);
long double scalblnl(long double __x, long __exponent) __INTRODUCED_IN_X86(18);
...
long double nextafterl(long double __x, long double __y) __RENAME_LDBL(nextafter, 3, 21);

double nexttoward(double __x, long double __y) __INTRODUCED_IN(18);
float nexttowardf(float __x, long double __y);
long double nexttowardl(long double __x, long double __y) __RENAME_LDBL(nexttoward, 18, 18);
...
long double fmal(long double __x, long double __y, long double __z) __RENAME_LDBL(fma, 3, 21);
