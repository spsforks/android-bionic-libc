...
double scalbln(double __x, long __exponent) __INTRODUCED_IN_X86_NDK_NO_GUARD(18);
float scalblnf(float __x, long __exponent) __INTRODUCED_IN_X86_NDK_NO_GUARD(18);
long double scalblnl(long double __x, long __exponent) __INTRODUCED_IN_X86_NDK_NO_GUARD(18);
...
long double nextafterl(long double __x, long double __y) __RENAME_LDBL_NDK_NO_GUARD(nextafter, 3, 21);

double nexttoward(double __x, long double __y) __INTRODUCED_IN_NDK_NO_GUARD(18);
float nexttowardf(float __x, long double __y);
long double nexttowardl(long double __x, long double __y) __RENAME_LDBL_NDK_NO_GUARD(nexttoward, 18, 18);
...
long double fmal(long double __x, long double __y, long double __z) __RENAME_LDBL_NDK_NO_GUARD(fma, 3, 21);
