...
double nan(const char*) __pure2 __INTRODUCED_IN_NON_X86(13);
...
float	lgammaf(float);
float tgammaf(float)  __INTRODUCED_IN_NON_X86(13);
...
long	lrintf(float);
long	lroundf(float);
float nanf(const char*) __pure2 __INTRODUCED_IN_NON_X86(13);
