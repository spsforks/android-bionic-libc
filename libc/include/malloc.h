...
/**
 * mallopt() option to set the maximum size of a cacheable item in
...
/**
 * mallopt() option to increase the maximum number of TSDs that can be used.
 * This number cannot be decreased, only increased and only applies to
 * the scudo allocator.
 *
 * Available since API level 30.
 */
