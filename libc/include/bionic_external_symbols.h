...
// Despite what it looks like, __BIONIC_INTERNAL__ is not a typical #include
// guard for this file. Its actually defined as part of the make file.
...
#undef pthread_once
#ifdef PTHREAD_ONCE_CPP
DEFINE_EXTERNAL(int, pthread_once, pthread_once_t* once_control, void (*init_routine)(void));
#endif
