...
// The 'strict' flag is required for NDK builds as we don't want weak symbols for the future APIs.
// NDK builds can be identified by the absence of __ANDROID_PLATFORM__
#if defined(__MAYBE_STRICT)
#error __MAYBE_STRICT already defined
#endif

#if defined(__ANDROID_PLATFORM__)
