...
#define __INTRODUCED_IN_NDK_NO_GUARD(api_level) __attribute__((annotate("introduced_in=" #api_level))) __VERSIONER_NO_GUARD
...
#define __INTRODUCED_IN_X86_NDK_NO_GUARD(api_level) __attribute__((annotate("introduced_in_x86=" #api_level))) __VERSIONER_NO_GUARD
...
//
// The _NDK_NO_GUARD variants keep the __VERSIONER_NO_GUARD behavior working for the NDK. This
...
#define __INTRODUCED_IN_NDK_NO_GUARD(api_level) __INTRODUCED_IN_X86(api_level)
#define __INTRODUCED_IN_X86_NDK_NO_GUARD(api_level) __INTRODUCED_IN_X86(api_level)
#else
#define __MAYBE_STRICT ,strict
#define __INTRODUCED_IN_NDK_NO_GUARD(api_level)
#define __INTRODUCED_IN_X86_NDK_NO_GUARD(api_level)
#endif
