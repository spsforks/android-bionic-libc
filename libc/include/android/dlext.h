...
enum {
  ...
  /* Instruct dlopen to use library_fd instead of opening file by name. The name
   * is still used to identify the library.
   */
  ANDROID_DLEXT_USE_FD                = 0x10,
