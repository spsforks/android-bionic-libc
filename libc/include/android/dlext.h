...
enum {
   ...
   * This is implemented this way because linker has to pick one address over the other and this way
   * is more convenient for art. Note that ANDROID_DLEXT_FORCE_FIXED_VADDR does not generate error
   * when min(p_vaddr) is 0.
   *
