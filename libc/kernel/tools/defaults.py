...
# the final headers. If the map value is True, that means that in
# addition to removing the structura, add an #include <bits/STRUCT.h>
# to the file.
kernel_structs_to_remove = {
    # Remove the structures since they are still the same as
    # timeval, itimerval.
    "__kernel_old_timeval": False,
    "__kernel_old_itimerval": False,
