...
def optimize_if01(blocks):
    ...
    while i < n:
        ...
        if r == 0:
            ...
            if dir_ == "endif":
                # If the directive we are removing is an elif then
                # we need to put the #endif.
                if start_dir == "elif":
                    logging.debug("adding endif")
                    result += blocks[j:j+1]
        ...
        if dir_ == "endif":
            ...
            # Skip over everything until we get to the next endif.
