...
__SC_COMP(__NR_sched_rr_get_interval, sys_sched_rr_get_interval, compat_sys_sched_rr_get_interval)
...
__SC_COMP(__NR_open_by_handle_at, sys_open_by_handle_at, compat_sys_open_by_handle_at)
