...
ifeq ($(strip $(TARGET_$(combo_2nd_arch_prefix)ARCH_VARIANT)),armv8-a)
cpu_variant_mk := $(LOCAL_PATH)/arch-arm/generic-armv8-a/generic-armv8-a.mk
else
cpu_variant_mk := $(LOCAL_PATH)/arch-arm/generic/generic.mk
endif
else
...
ifneq ($(SUPPORTED_ARMV7_CPU_VARIANTS),)
$(info "Supported ARMv7 CPU variants: $(SUPPORTED_ARMV7_CPU_VARIANTS)")
endif
ifneq ($(SUPPORTED_ARMV8_CPU_VARIANTS),)
$(info "Supported ARMv8 CPU variants: $(SUPPORTED_ARMV8_CPU_VARIANTS)")
endif
$(error "TARGET_CPU_VARIANT not set or set to an unknown value. Use generic for devices that do not have a CPU similar to any of the supported cpu variants.")
endif
