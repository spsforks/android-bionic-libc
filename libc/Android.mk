...
ifeq ($(TARGET_ARCH),arm)
  ...
  ifeq ($(ARCH_ARM_NEON_SUPPORTS_UNALIGNED_ACCESS),true)
    ...
    #
    ifneq ($(strip $(BIONIC_MEMCPY_ALIGNMENT_DIVIDER)),)
      libc_common_cflags += -DMEMCPY_ALIGNMENT_DIVIDER=$(strip $(BIONIC_MEMCPY_ALIGNMENT_DIVIDER))
    endif
  endif
  #
  ...
  #
  ifneq ($(strip $(BIONIC_MEMSET_NEON_DIVIDER)),)
    libc_common_cflags += -DMEMSET_NEON_DIVIDER=$(strip $(BIONIC_MEMSET_NEON_DIVIDER))
  endif
else # !arm
