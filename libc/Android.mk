...
libc_common_src_files_$(TARGET_2ND_ARCH) :=
my_2nd_arch_prefix := $(TARGET_2ND_ARCH_VAR_PREFIX)
include $(LOCAL_PATH)/arch-$(TARGET_2ND_ARCH)/$(TARGET_2ND_ARCH).mk
include $(LOCAL_PATH)/arch-$(TARGET_2ND_ARCH)/syscalls.mk
libc_common_src_files_$(TARGET_2ND_ARCH) += $(syscall_src)
my_2nd_arch_prefix :=

libc_common_additional_dependencies += \
    $(LOCAL_PATH)/arch-$(TARGET_2ND_ARCH)/$(TARGET_2ND_ARCH).mk \
    $(LOCAL_PATH)/arch-$(TARGET_2ND_ARCH)/syscalls.mk
endif
...
ifdef TARGET_2ND_ARCH
LOCAL_CFLAGS_$(TARGET_2ND_ARCH) := $(libc_common_cflags_$(TARGET_2ND_ARCH))
endif
...
LOCAL_SRC_FILES_$(TARGET_ARCH) := $(libc_bionic_src_files_$(TARGET_ARCH))
LOCAL_CFLAGS_$(TARGET_ARCH) := $(libc_common_cflags_$(TARGET_ARCH))
ifdef TARGET_2ND_ARCH
LOCAL_SRC_FILES_$(TARGET_2ND_ARCH) := $(libc_bionic_src_files_$(TARGET_2ND_ARCH))
LOCAL_CFLAGS_$(TARGET_2ND_ARCH) := $(libc_common_cflags_$(TARGET_2ND_ARCH))
endif
include $(BUILD_STATIC_LIBRARY)
...
LOCAL_SRC_FILES_$(TARGET_ARCH) := $(libc_common_src_files_$(TARGET_ARCH))
LOCAL_CFLAGS_$(TARGET_ARCH) := $(libc_common_cflags_$(TARGET_ARCH))
# TODO: split out the asflags.
LOCAL_ASFLAGS_$(TARGET_ARCH) := $(LOCAL_CFLAGS_$(TARGET_ARCH))
ifdef TARGET_2ND_ARCH
LOCAL_SRC_FILES_$(TARGET_2ND_ARCH) := $(libc_common_src_files_$(TARGET_2ND_ARCH))
LOCAL_CFLAGS_$(TARGET_2ND_ARCH) := $(libc_common_cflags_$(TARGET_2ND_ARCH))
# TODO: split out the asflags.
LOCAL_ASFLAGS_$(TARGET_2ND_ARCH) := $(LOCAL_CFLAGS_$(TARGET_2ND_ARCH))
endif
include $(BUILD_STATIC_LIBRARY)
...
LOCAL_SRC_FILES_$(TARGET_ARCH) := $(libc_arch_static_src_files_$(TARGET_ARCH))
LOCAL_CFLAGS_$(TARGET_ARCH) := $(libc_common_cflags_$(TARGET_ARCH))
ifdef TARGET_2ND_ARCH
LOCAL_SRC_FILES_$(TARGET_2ND_ARCH) := $(libc_arch_static_src_files_$(TARGET_2ND_ARCH))
LOCAL_CFLAGS_$(TARGET_2ND_ARCH) := $(libc_common_cflags_$(TARGET_2ND_ARCH))
endif
include $(BUILD_STATIC_LIBRARY)
...
LOCAL_SRC_FILES_$(TARGET_ARCH) := \
    $(libc_arch_dynamic_src_files_$(TARGET_ARCH)) \
    $(libc_static_common_src_files_$(TARGET_ARCH))
LOCAL_CFLAGS_$(TARGET_ARCH) := $(libc_common_cflags_$(TARGET_ARCH))
ifdef TARGET_2ND_ARCH
LOCAL_SRC_FILES_$(TARGET_2ND_ARCH) := \
    $(libc_arch_dynamic_src_files_$(TARGET_2ND_ARCH)) \
    $(libc_static_common_src_files_$(TARGET_2ND_ARCH))
LOCAL_CFLAGS_$(TARGET_2ND_ARCH) := $(libc_common_cflags_$(TARGET_2ND_ARCH))
endif
# special for arm
