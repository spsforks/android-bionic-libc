...
SIGRTMIN + 10 (which is 46 on most Android devices). When this
...
name in parenthesis indicates that the free function was called with the
bad pointer.
...
Would indicate that a realloc function was called with an already freed pointer.
