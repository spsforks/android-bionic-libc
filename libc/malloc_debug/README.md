...
There are now multiples version of the file:
...
NUM\_ALLOCATIONS to an incorrect value. All versions of the heap dump in
v1.0, the NUM\_ALLOCATIONS value is always 1 no matter what is actually
present.
