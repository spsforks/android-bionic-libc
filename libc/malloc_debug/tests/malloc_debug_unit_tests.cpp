...
TEST_F(MallocDebugTest, backtrace_dump_on_signal) {
  Init("backtrace=4");
  ...
  for (auto& line : android::base::Split(actual, "\n")) {
    if (skip_map_data) {
      if (line == "END") {
        if (map_data_found) {
          sanitized += "MAP_DATA\n";
  ...
  std::string expected =
      ...
      "\n"
#if defined(__LP64__)
      "z 0  sz       50  num    2  bt 000000000000a000 000000000000b000\n"
      "z 1  sz      100  num    2  bt 0000000000000100 0000000000000200\n"
#else
      "z 0  sz       50  num    2  bt 0000a000 0000b000\n"
      "z 1  sz      100  num    2  bt 00000100 00000200\n"
#endif
      "MAPS\n"
      "MAP_DATA\n"
      "END\n\n";
