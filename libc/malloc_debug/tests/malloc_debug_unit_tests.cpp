...
#define MAYBE_debug_malloc_info_no_pointer_tracking DISABLED_malloc_info_no_pointer_tracking
#else
#define MAYBE_debug_mallinfo debug_mallinfo
#define MAYBE_debug_malloc_info_no_pointer_tracking malloc_info_no_pointer_tracking
#endif
