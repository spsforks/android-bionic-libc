...
std::string usage_string(
  ...
  "6 malloc_debug     of backtrace frames. The default is 32 frames.\n"
  "6 malloc_debug \n"
...
TEST_F(MallocDebugConfigTest, enable_record_fail) {
  MallocDebugConfig config;

  property_set("libc.debug.malloc.options", "enable_record=100");
  ASSERT_FALSE(config.SetFromProperties());
