...
static const prop_info* g_pinfo = __system_property_find("debug.atrace.tags.enableflags");
static uint32_t g_serial = -1;
static uint64_t g_tags = ATRACE_TAG_NOT_READY;
static int g_trace_marker_fd = -1;

ScopedTrace::ScopedTrace(const char* message) {
  if(g_pinfo != NULL || this->tracingReady()) {
