...
int clock_gettime(int clock_id, timespec* tp) {
  int (*vdso_clock_gettime)(int, timespec*) =
    reinterpret_cast<int (*)(int, timespec*)>(
...
int gettimeofday(timeval* tv, struct timezone* tz) {
  int (*vdso_gettimeofday)(timeval*, struct timezone*) =
    reinterpret_cast<int (*)(timeval*, struct timezone*)>(
      __libc_globals->vdso[VDSO_GETTIMEOFDAY].fn);
  return vdso_gettimeofday(tv, tz);
}

void __libc_init_vdso(wp_mutator<libc_globals_t> &globals) {
  auto&& vdso = globals->vdso;
  vdso[VDSO_CLOCK_GETTIME] = { VDSO_CLOCK_GETTIME_SYMBOL, reinterpret_cast<void*>(__clock_gettime) };
  vdso[VDSO_GETTIMEOFDAY] = { VDSO_GETTIMEOFDAY_SYMBOL, reinterpret_cast<void*>(__gettimeofday) };
...
#endif // defined(__aarch64__) || defined(__x86_64__) || defined (__i386__)
