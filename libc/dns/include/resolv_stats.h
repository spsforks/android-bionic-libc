...
/* Returns true if the server is considered valid, i.e. if the success rate is not lower than the
 * threshold for the stored stored samples (and there are enough stored samples).
 */
extern bool
