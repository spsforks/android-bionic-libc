...
load("//third_party/bazel_rules/rules_cc/cc:find_cc_toolchain.bzl", "find_cc_toolchain")
...
cc_shared_library = rule(
    ...
    toolchains = ["//third_party/bazel_rules/rules_cc/cc:toolchain_type"],  # copybara-use-repo-external-label
