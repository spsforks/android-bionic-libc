...
def is_interesting(path_str: str) -> bool:
    ...
    if path.suffix in uninteresting_extensions:
        return False
    if path.name in {"notice", "readme", "pylintrc", "test_mapping"}:
        return False
...
def is_auto_generated(content: Sequence[str]) -> bool:
    autogenerated_banners = [
        "Generated by gensyscalls.py",
        "generated by genserv.py",
        "This header was automatically generated from a Linux kernel header",
        "DO NOT EDIT THIS FILE - it is machine generated",
    ]
    for autogenerated_banner in autogenerated_banners:
        if autogenerated_banner in content:
            return True
    return False
...
def do_file(path: str) -> None:
    ...
    if not "Copyright" in content:
        if any(domain in content.lower() for domain in ["public domain", "publicdomain"]):
