...
# script should be in bionic/libc/tools for correct roots autodetection
#
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(formatter_class = argparse.RawTextHelpFormatter,
                                     description = 'Headers comparsion tool between bionic and NDK platforms')
