...
libgcc_build_path = os.environ["ANDROID_BUILD_TOP"] + "/bionic/libc"
...
class Generator:
    def process(self, build_path, location_path, file_name):
        ...
        p = subprocess.Popen([build_path + "/tools/genlibgcc_compat_mm_wrapper.sh", build_output_file_path], cwd=build_path);
        retcode = p.wait()
