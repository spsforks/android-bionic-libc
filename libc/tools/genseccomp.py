...
def construct_bpf(syscall_files, architecture, header_dir, output_path):
  ...
  output = convert_bpf_to_output(bpf, architecture)
...
def main():
  setDir()
  construct_bpf(android_syscall_files, arm_architecture, arm_headers,
                "seccomp/arm_policy.c")
  construct_bpf(android_syscall_files, arm64_architecture, arm64_headers,
                "seccomp/arm64_policy.c")
