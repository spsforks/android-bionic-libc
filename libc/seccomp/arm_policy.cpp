...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 27, 110, 109), //ptrace
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 34, 109, 108), //access
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 41, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 38, 107, 106), //sync|kill
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 46, 102, 101), //brk
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 62, 95, 94), //umask|chroot
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 76, 91, 90), //sethostname|setrlimit
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 80, 86, 85), //getrusage|gettimeofday|settimeofday
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 86, 85, 84), //readlink
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 91, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 89, 83, 82), //swapon|reboot
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 93, 82, 81), //munmap|truncate
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 103, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 96, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 95, 79, 78), //fchmod
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 98, 78, 77), //getpriority|setpriority
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 114, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 106, 76, 75), //syslog|setitimer|getitimer
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 123, 71, 70), //fsync|sigreturn|clone|setdomainname|uname
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 137, 64, 63), //personality
