...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 39, 100, 99), //sync|kill|rename
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 65, 87, 86), //getppid
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 89, 75, 74), //reboot
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 142, 51, 50), //setfsuid|setfsgid|_llseek|getdents
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 150, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 149, 49, 48), //flock|msync|readv|writev|getsid|fdatasync
