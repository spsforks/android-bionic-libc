...
const struct sock_filter x86_filter[] = {
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 2, 103, 102), //restart_syscall|exit
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 7, 102, 101), //read|write|open|close
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 10, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 9, 100, 99), //creat
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 13, 99, 98), //unlink|execve|chdir
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 33, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 26, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 22, 96, 95), //lseek|getpid|mount
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 55, 83, 82), //ioctl
