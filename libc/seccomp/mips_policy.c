...
const struct sock_filter mips_filter[] = {
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4036, 15, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4019, 7, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4008, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4003, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4002, 107, 106), //exit
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4007, 106, 105), //read|write|open|close
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4010, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4009, 104, 103), //creat
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4013, 103, 102), //unlink|execve|chdir
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4026, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4023, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4022, 100, 99), //lseek|getpid|mount
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4025, 99, 98), //setuid|getuid
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4033, 1, 0),
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4038, 92, 91), //sync|kill
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4055, 85, 84), //ioctl
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4093, 69, 68), //munmap|truncate
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 4117, 62, 61), //wait4|swapoff|sysinfo
