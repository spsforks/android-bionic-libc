...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 2, 117, 116), //restart_syscall|exit
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 7, 116, 115), //read|write|open|close
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 10, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 9, 114, 113), //creat
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 13, 113, 112), //unlink|execve|chdir
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 33, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 26, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 22, 110, 109), //lseek|getpid|mount
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 55, 98, 97), //ioctl
