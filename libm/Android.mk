...
#
include $(CLEAR_VARS)
LOCAL_SRC_FILES := $(libm_common_src_files) $(libm_$(HOST_ARCH)_src_files)
LOCAL_C_INCLUDES += $(libm_common_includes) $(libm_$(HOST_ARCH)_includes)
LOCAL_CFLAGS := $(libm_common_cflags) $(libm_$(HOST_ARCH)_cflags)
LOCAL_MODULE:= libm
LOCAL_ADDITIONAL_DEPENDENCIES := $(LOCAL_PATH)/Android.mk
LOCAL_SYSTEM_SHARED_LIBRARIES := libc
