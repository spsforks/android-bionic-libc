...
ifneq ($(strip $(wildcard bionic/libm/$(TARGET_ARCH)/$(TARGET_ARCH).mk)),)
my_2nd_arch_prefix :=
...
ifneq ($(strip $(wildcard bionic/libm/$(TARGET_2ND_ARCH)/$(TARGET_2ND_ARCH).mk)),)
...
LOCAL_SRC_FILES_arm := arm/fenv.c $(libm_common_src_files_arm)

LOCAL_C_INCLUDES_arm64 := $(libm_ld_includes)
LOCAL_SRC_FILES_arm64 := arm64/fenv.c $(libm_ld_src_files) $(libm_common_src_files_arm64)

LOCAL_C_INCLUDES_x86 := $(LOCAL_PATH)/i387
LOCAL_SRC_FILES_x86 := i387/fenv.c $(libm_common_src_files_x86)

LOCAL_C_INCLUDES_x86_64 := $(libm_ld_includes)
LOCAL_SRC_FILES_x86_64 := amd64/fenv.c $(libm_ld_src_files) $(libm_common_src_files_x86_64)

LOCAL_SRC_FILES_mips := mips/fenv.c

LOCAL_C_INCLUDES_mips64 := $(libm_ld_includes)
LOCAL_SRC_FILES_mips64 := mips/fenv.c $(libm_ld_src_files) $(libm_common_src_files_mips64)
