...
# We fake this for systems where 'long double' is just 'double', because
# it's used in the implementation of rint.
libm_common_src_files += \
    rintl.c \
...
# TODO: only partial "long double" support so far:
# TODO: these only work on x86 because of "Unsupported long double format".
