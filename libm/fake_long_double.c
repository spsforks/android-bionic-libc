...
/*
 * On LP64 long double is not the same size as double so we loose precision when
 * we fallback to the double variants. Emit a warning whenever something links
 * against them.
 */
#ifdef __LP64__
