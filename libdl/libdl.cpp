...
__loader_debuggerd_first_chance_signal_handler(int signal_number, siginfo_t* info, void* context);
...
__attribute__((__weak__)) bool debuggerd_first_chance_signal_handler(int signal_number,
                                                                     siginfo_t* info,
                                                                     void* context) {
