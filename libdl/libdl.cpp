...
// This function returns false if the sigchain handler should continue. This function returns true
// if the sigchain handler should immediately return, which happens when the signal came from
// GWP-ASan, and we've dumped a debuggerd report and patched up the GWP-ASan allocator to recover
// from the fault, and regular execution of the program can continue.
