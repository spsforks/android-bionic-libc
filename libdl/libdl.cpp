...
__attribute__((__weak__, visibility("default"))) bool __loader_android_first_chance_signal_handler(
...
__attribute__((__weak__)) bool android_first_chance_signal_handler(int signal_number,
                                                                   siginfo_t* info, void* context) {
  return __loader_android_first_chance_signal_handler(signal_number, info, context);
}
