...
__attribute__((__weak__, visibility("default")))
void* __loader_dlsym(void* handle, const char* symbol);

__attribute__((__weak__, visibility("default")))
void* __loader_dlvsym(void* handle, const char* symbol, const char* version);
...
void* dlopen(const char* filename, int flag) {
  return __loader_dlopen(filename, flag);
}
...
void* dlsym(void* handle, const char* symbol) {
  return __loader_dlsym(handle, symbol);
}

void* dlvsym(void* handle, const char* symbol, const char* version) {
  return __loader_dlvsym(handle, symbol, version);
}
...
void* android_dlopen_ext(const char* filename, int flag, const android_dlextinfo* extinfo) {
  return __loader_android_dlopen_ext(filename, flag, extinfo);
}
