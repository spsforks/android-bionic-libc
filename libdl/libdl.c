...
bool _dl_android_set_application_sdk_versions(uint32_t target __unused, uint32_t min __unused, uint32_t max __unused) { return false; }
uint32_t _dl_andorid_get_application_target_sdk_version() { return 0; }
