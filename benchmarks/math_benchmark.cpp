...
BENCHMARK_WITH_ARG(BM_math_isinf, double)->Arg(1234.0)->Arg(nan(""))->Arg(HUGE_VAL)->Arg(0.0);
...
BENCHMARK_WITH_ARG(BM_math_fpclassify, double)->Arg(1234.0)->Arg(nan(""))->Arg(HUGE_VAL)->Arg(0.0);
