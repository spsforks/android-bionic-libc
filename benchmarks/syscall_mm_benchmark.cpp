...
// file mmap
static void BM_syscall_mmap_file_r_priv(benchmark::State& state) {
  struct MmapParams params = {
      .prot = PROT_READ,
      .flags = MAP_PRIVATE,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_file_r_priv, "AT_All_PAGE_SIZES");
...
static void BM_syscall_mmap_anon_mprotect_rw_to_r(benchmark::State& state) {
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_anon_mprotect_rw_to_r, "AT_All_PAGE_SIZES");
...
static void BM_syscall_mmap_anon_mprotect_rw_to_w(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_READ | PROT_WRITE,
      .to_prot = PROT_WRITE,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_anon_mprotect_rw_to_w, "AT_All_PAGE_SIZES");

static void BM_syscall_mmap_anon_mprotect_r_to_none(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_READ,
      .to_prot = PROT_NONE,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_anon_mprotect_r_to_none, "AT_All_PAGE_SIZES");

static void BM_syscall_mmap_anon_mprotect_r_to_w(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_READ,
      .to_prot = PROT_WRITE,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_anon_mprotect_r_to_w, "AT_All_PAGE_SIZES");

static void BM_syscall_mmap_anon_mprotect_w_to_r(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_WRITE,
      .to_prot = PROT_READ,
      .size = state.range(0),
  };
  MprotectBenchmarkWithMmapAnon(state, params);
}
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_anon_mprotect_w_to_r, "AT_All_PAGE_SIZES");

static void BM_syscall_mmap_anon_mprotect_w_to_none(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_WRITE,
      .to_prot = PROT_NONE,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_anon_mprotect_w_to_none, "AT_All_PAGE_SIZES");
...
static void BM_syscall_mmap_file_mprotect_rw_to_r(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_READ | PROT_WRITE,
      .to_prot = PROT_READ,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_file_mprotect_rw_to_r, "AT_All_PAGE_SIZES");
...
static void BM_syscall_mmap_file_mprotect_rw_to_w(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_READ | PROT_WRITE,
      .to_prot = PROT_WRITE,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_file_mprotect_rw_to_w, "AT_All_PAGE_SIZES");
...
static void BM_syscall_mmap_file_mprotect_none_to_r(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_NONE,
      .to_prot = PROT_READ,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_file_mprotect_none_to_r, "AT_All_PAGE_SIZES");

static void BM_syscall_mmap_file_mprotect_r_to_none(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_READ,
      .to_prot = PROT_NONE,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_file_mprotect_r_to_none, "AT_All_PAGE_SIZES");

static void BM_syscall_mmap_file_mprotect_w_to_r(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_WRITE,
      .to_prot = PROT_READ,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_file_mprotect_w_to_r, "AT_All_PAGE_SIZES");
