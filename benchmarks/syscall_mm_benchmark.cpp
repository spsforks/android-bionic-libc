...
static void BM_syscall_mmap_anon_mprotect_rw_to_wr(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_READ | PROT_WRITE,
      .to_prot = PROT_WRITE,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_anon_mprotect_rw_to_wr, "AT_All_PAGE_SIZES");
...
static void BM_syscall_mmap_anon_mprotect_rd_to_wr(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_READ,
      .to_prot = PROT_WRITE,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_anon_mprotect_rd_to_wr, "AT_All_PAGE_SIZES");

static void BM_syscall_mmap_anon_mprotect_wr_to_rd(benchmark::State& state) {
  struct MprotectParams params = {
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_anon_mprotect_wr_to_rd, "AT_All_PAGE_SIZES");

static void BM_syscall_mmap_anon_mprotect_wr_to_none(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_WRITE,
      .to_prot = PROT_NONE,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_anon_mprotect_wr_to_none, "AT_All_PAGE_SIZES");
...
static void BM_syscall_mmap_file_mprotect_rw_to_wr(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_READ | PROT_WRITE,
      .to_prot = PROT_WRITE,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_file_mprotect_rw_to_wr, "AT_All_PAGE_SIZES");
...
static void BM_syscall_mmap_file_mprotect_wr_to_rd(benchmark::State& state) {
  struct MprotectParams params = {
      .from_prot = PROT_WRITE,
      .to_prot = PROT_READ,
      .size = state.range(0),
...
BIONIC_BENCHMARK_WITH_ARG(BM_syscall_mmap_file_mprotect_wr_to_rd, "AT_All_PAGE_SIZES");
