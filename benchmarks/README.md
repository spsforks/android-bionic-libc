...
'--bionic_xml'. When operated without specifying an xml file, the default is to use the xml
...
If no suite is specified through the command-line option, the default is to use  suites/full.xml`.
