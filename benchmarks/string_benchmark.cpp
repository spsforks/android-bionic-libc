...
char *getAlignedMemory(char *orig_ptr, size_t alignment, size_t or_mask) {
  if ((alignment & (alignment - 1)) != 0) {
    fprintf(stderr, "warning: alignment passed into getAlignedMemory is not a power of two. Setting it to the default alignment...\n");
    alignment = 0;
  }
  if (or_mask > alignment) {
    fprintf(stderr, "warning: or_mask passed into getAlignedMemory is too high. Setting it to 0...\n");
    or_mask = 0;
  }
