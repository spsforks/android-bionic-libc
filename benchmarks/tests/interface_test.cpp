...
TEST_F(SystemTests, full_suite) {
  std::string expected =
    ...
    "BM_time_clock_gettime_TAI/iterations:1\n"
    "BM_time_clock_gettime_unsupported/iterations:1\n"
    ...
    "BM_time_clock_getres_TAI/iterations:1\n"
    "BM_time_clock_getres_unsupported/iterations:1\n"
