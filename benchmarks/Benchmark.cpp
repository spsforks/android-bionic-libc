...
std::string BenchmarkWithoutArgs::GetNameStr(void*) {
  return Name();
}

template <>
std::string BenchmarkWithArgs<int>::GetNameStr(int arg) {
  return Name() + "/" + PrettyInt(arg, 2);
}

template <>
std::string BenchmarkWithArgs<double>::GetNameStr(double arg) {
...
template class BenchmarkWithArgs<int>;
template class BenchmarkWithArgs<double>;
