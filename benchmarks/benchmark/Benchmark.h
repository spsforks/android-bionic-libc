...
class BenchmarkWithoutArgs : public BenchmarkT<void*> {
public:
  BenchmarkWithoutArgs() {}
  virtual ~BenchmarkWithoutArgs() {}
...
template<typename T>
class BenchmarkWithArgs : public BenchmarkT<T> {
public:
  BenchmarkWithArgs() {}
  virtual ~BenchmarkWithArgs() {}

  BenchmarkWithArgs* Arg(T arg) {
    args_.push_back(arg);
    return this;
  }
...
#define BENCHMARK_NO_ARG(f) \
  BENCHMARK_START(f, ::testing::BenchmarkWithoutArgs) \
    virtual void Run(int) override; \
  }; \
  static ::testing::Benchmark* __benchmark_##f = new f()

#define BENCHMARK_WITH_ARG(f, arg_type) \
  BENCHMARK_START(f, ::testing::BenchmarkWithArgs<arg_type>) \
    virtual void Run(int, arg_type) override; \
  }; \
  static ::testing::BenchmarkWithArgs<arg_type>* __benchmark_##f = (new f())
