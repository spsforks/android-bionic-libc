...
static void BM_time_clock_getres_MONOTONIC_COARSE_(benchmark::State& state) {
  // CLOCK_MONOTONIC_COARSE is required supported in vdso
  timespec t;
  while (state.KeepRunning()) {
...
BIONIC_BENCHMARK(BM_time_clock_getres_MONOTONIC_COARSE_);

static void BM_time_clock_getres_MONOTONIC_RAW_(benchmark::State& state) {
  // CLOCK_MONOTONIC_RAW is required supported in vdso
  timespec t;
  while (state.KeepRunning()) {
...
BIONIC_BENCHMARK(BM_time_clock_getres_MONOTONIC_RAW_);
...
static void BM_time_clock_getres_REALTIME_COARSE_(benchmark::State& state) {
  // CLOCK_REALTIME_COARSE is required supported in vdso
  timespec t;
  while (state.KeepRunning()) {
...
BIONIC_BENCHMARK(BM_time_clock_getres_REALTIME_COARSE_);
...
static void BM_time_clock_getres_TAI_(benchmark::State& state) {
...
BIONIC_BENCHMARK(BM_time_clock_getres_TAI_);

static void BM_time_clock_getres_unsupported_(benchmark::State& state) {
...
BIONIC_BENCHMARK(BM_time_clock_getres_unsupported_);
